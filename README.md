...
Sleep Apnea is a disorder that causes breathing to stop and start repeatedly during sleep. The aim of this project is to detect apnea events by monitoring sleep signals and employing signal processing and machine learning techniques.
The device interprets body signals like ECG to identify sleep segments as either Normal or Apnea which can lead to early detection and improved sleep health evaluation.

# 🎯Objectives

To analyze sleep-related physiological signals

To detect sleep apnea events automatically
